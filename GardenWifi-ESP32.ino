...
//Ticker displayTicker; /** Tick.er(timer) to periodically refresh display */
...
void setup() {
  ...
  ts.add(5,  15000, [&](void *) { checkBattery();}, nullptr, true);
  //ts.add(5,  6000, [&](void *) { checkBattery(); displayBattDebug();}, nullptr, true);
  delay(2500);
